"""Example: Climate Technology and Carbon Capture Research

This example demonstrates using local Ollama models to research
emerging climate technologies and carbon capture solutions.
"""
import asyncio
import os
...
async def run_climate_tech_research():
    """Run climate technology and carbon capture research."""

    query = """What are the most promising direct air capture (DAC) and carbon
    sequestration technologies currently being developed? Compare their
    scalability, cost-effectiveness, and environmental impact."""

    print("\n" + "="*70)
    print("CLIMATE TECHNOLOGY AND CARBON CAPTURE RESEARCH")
    print("="*70)
    print(f"\nQuery: {query}")
    print("\nConfiguration:")
    ...
    try:
        ...
        if final_state and isinstance(final_state, dict):
            ...
            if final_report:
                ...
                filename = f"{output_dir}/climate_tech_carbon_capture_{timestamp}.md"

                # Save report
                with open(filename, "w", encoding="utf-8") as f:
                    f.write(f"# Climate Technology and Carbon Capture Research Report\n\n")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("LOCAL OLLAMA RESEARCH EXAMPLE: CLIMATE TECHNOLOGY")
    print("="*70)

    # Run the research
    result = asyncio.run(run_climate_tech_research())
