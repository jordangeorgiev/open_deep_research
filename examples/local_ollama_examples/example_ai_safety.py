"""Example: AI Safety and Alignment Research

This example demonstrates using local Ollama models to research
AI safety techniques and alignment approaches for large language models.
"""
import asyncio
import os
...
async def run_ai_safety_research():
    """Run AI safety and alignment research."""
    ...
    print("\n" + "="*70)
    print("AI SAFETY AND ALIGNMENT RESEARCH")
    print("="*70)
    print(f"\nQuery: {query}")
    print("\nConfiguration:")
    ...
    try:
        ...
        if final_state and isinstance(final_state, dict):
            ...
            if final_report:
                ...
                filename = f"{output_dir}/ai_safety_alignment_{timestamp}.md"

                # Save report
                with open(filename, "w", encoding="utf-8") as f:
                    f.write(f"# AI Safety and Alignment Research Report\n\n")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("LOCAL OLLAMA RESEARCH EXAMPLE: AI SAFETY")
    print("="*70)

    # Run the research
    result = asyncio.run(run_ai_safety_research())
