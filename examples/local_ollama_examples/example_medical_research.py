"""Example: mRNA Vaccine Technology Research

This example demonstrates using local Ollama models to research
mRNA vaccine technology and its applications beyond COVID-19.
"""
import asyncio
import os
...
async def run_medical_research():
    """Run mRNA vaccine technology research."""

    query = """What are the latest developments in mRNA vaccine technology
    beyond COVID-19? Explore applications in cancer treatment, rare diseases,
    and personalized medicine, including current clinical trials and challenges."""

    print("\n" + "="*70)
    print("mRNA VACCINE TECHNOLOGY RESEARCH")
    print("="*70)
    print(f"\nQuery: {query}")
    print("\nConfiguration:")
    ...
    try:
        ...
        if final_state and isinstance(final_state, dict):
            ...
            if final_report:
                ...
                filename = f"{output_dir}/mrna_vaccine_technology_{timestamp}.md"

                # Save report
                with open(filename, "w", encoding="utf-8") as f:
                    f.write(f"# mRNA Vaccine Technology Research Report\n\n")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("LOCAL OLLAMA RESEARCH EXAMPLE: MEDICAL RESEARCH")
    print("="*70)

    # Run the research
    result = asyncio.run(run_medical_research())
